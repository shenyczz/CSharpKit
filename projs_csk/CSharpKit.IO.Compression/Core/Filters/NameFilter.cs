...
{
	/// <summary>
	/// 名称筛选器是一个字符串匹配类，它允许正匹配和负匹配。<br/>
	/// NameFilter is a string matching class which allows for both positive and negative matching.
	...
	public class NameFilter : IScanFilter
	{
		...
		{
			_filter = filter;
			_inclusions = new List<Regex>();
			_exclusions = new List<Regex>();
			Compile();
		}
		...
		private List<Regex> _inclusions;
		private List<Regex> _exclusions;
