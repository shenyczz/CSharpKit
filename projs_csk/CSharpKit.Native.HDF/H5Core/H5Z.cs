...
namespace CSharpKit.Native.HDF
{
    ...
    /// H5 Zip
    /// </summary>
    public unsafe sealed class H5Z : H5Common
    {
        static H5Z() { H5.open(); }
        ...
        [DllImport(DLLFileName, EntryPoint = "H5Zfilter_avail",
        ...
        /// on failure.</returns>
        [DllImport(DLLFileName, EntryPoint = "H5Zget_filter_info",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
        ...
        [DllImport(DLLFileName, EntryPoint = "H5Zregister",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
        ...
        /// <returns>Returns a non-negative value if successful; otherwise
        /// returns a negative value.</returns>
        [DllImport(DLLFileName, EntryPoint = "H5Zunregister",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
