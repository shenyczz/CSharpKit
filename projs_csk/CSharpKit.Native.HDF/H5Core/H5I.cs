...
namespace CSharpKit.Native.HDF
{
    ...
    /// H5 Identify
    /// </summary>
    public unsafe sealed class H5I : H5Common
    {
        static H5I() { H5.open(); }
        ...
        /// </summary>
        public const hid_t INVALID_HID = -1;
        ...
        [DllImport(DLLFileName, EntryPoint = "H5Iclear_type",
        ...
        [DllImport(DLLFileName, EntryPoint = "H5Idec_ref",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
        ...
        /// on failure.</returns>
        [DllImport(DLLFileName, EntryPoint = "H5Idec_type_ref",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
        ...
        /// destroyed</param>
        /// <returns>Returns non-negative on success, negative on failure.</returns>
        [DllImport(DLLFileName, EntryPoint = "H5Idestroy_type",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
        ...
        [DllImport(DLLFileName, EntryPoint = "H5Iget_file_id",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
        ...
        [DllImport(DLLFileName, EntryPoint = "H5Iget_name",
        ...
        /// returned.</returns>
        [DllImport(DLLFileName, EntryPoint = "H5Iget_ref",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
        ...
        [DllImport(DLLFileName, EntryPoint = "H5Iget_type",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
        ...
        /// returned.</returns>
        [DllImport(DLLFileName, EntryPoint = "H5Iinc_ref",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
        ...
        /// <returns>Returns the current reference count on success, negative
        /// on failure.</returns>
        [DllImport(DLLFileName, EntryPoint = "H5Iinc_type_ref",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
        ...
        [DllImport(DLLFileName, EntryPoint = "H5Iis_valid",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
        ...
        [DllImport(DLLFileName, EntryPoint = "H5Inmembers",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
        ...
        [DllImport(DLLFileName, EntryPoint = "H5Iobject_verify",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
        ...
        [DllImport(DLLFileName, EntryPoint = "H5Iregister",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
        ...
        /// failure.</returns>
        [DllImport(DLLFileName, EntryPoint = "H5Iregister_type",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
        ...
        [DllImport(DLLFileName, EntryPoint = "H5Iremove_verify",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
        ...
        [DllImport(DLLFileName, EntryPoint = "H5Isearch",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
        ...
        [DllImport(DLLFileName, EntryPoint = "H5Itype_exists",
            CallingConvention = CallingConvention.Cdecl),
        SuppressUnmanagedCodeSecurity, SecuritySafeCritical]
