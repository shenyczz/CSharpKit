...
namespace CSharpKit.GeoApi.Geometries
{
    ...
    public interface IGeometryFactory
    {
        ...
        ILinearString CreateLineString();
        ...
        ILinearString CreateLinearString(ICoordinate[] coordinates);
        ...
        /// <param name="coordinates">An array without null elements, or an empty array, or null.</param>
        /// <returns>A LineString</returns>
        ILinearString CreateLinearString(ICoordinateSequence coordinates);
        ...
        IMultiLinearString CreateMultiLineString();
        ...
        IMultiLinearString CreateMultiLinearString(ILinearString[] lineStrings);
