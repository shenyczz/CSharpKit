...
namespace CSharpKit.GeoApi.CoordinateSystems
{
    ...
    public interface ICoordinateSystemFactory
	{
		...
		IFittedCoordinateSystem CreateFittedCoordinateSystem(string name, ICoordinateSystem baseCoordinateSystem, string toBaseWkt, List<IAxisInfo> arAxes);
		...
		IGeographicCoordinateSystem CreateGeographicCoordinateSystem(string name, IAngularUnit angularUnit, IHorizontalDatum datum, IPrimeMeridian primeMeridian, IAxisInfo axis0, IAxisInfo axis1);
		...
		IHorizontalDatum CreateHorizontalDatum(string name, DatumType datumType, IEllipsoid ellipsoid, IWgs84ConversionInfo toWgs84);
		...
		ILocalCoordinateSystem CreateLocalCoordinateSystem(string name, ILocalDatum datum, IUnit unit, List<IAxisInfo> axes);
		...
		IProjection CreateProjection(string name, string wktProjectionClass, List<IProjectionParameter> Parameters);
		...
		IVerticalCoordinateSystem CreateVerticalCoordinateSystem(string name, IVerticalDatum datum, ILinearUnit verticalUnit, IAxisInfo axis);
