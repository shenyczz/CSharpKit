...
namespace CSharpKit.GeoApi.Geometries
{
    ...
    public class GeometryCollection<T> : Geometry, IGeometryCollection<T>
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        private List<T> _tSet;

        #endregion


        public void AddRange(IEnumerable<T> geoms)
        {
            _tSet.AddRange(geoms);
        }
        ...
        object IList.this[int index] { get => ((IList)_tSet)[index]; set => ((IList)_tSet)[index] = value; }
